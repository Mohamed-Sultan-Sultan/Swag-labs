...
public class TC08_InvalidLandingTest {
    private final String USERNAME = DataUtils.getJsonData("InvalidLanding", "username");
    private final String PASSWORD = DataUtils.getJsonData("InvalidLanding", "password");
